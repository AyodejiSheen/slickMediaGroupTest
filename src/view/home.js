                        ...
                        video.filter((each) => {
                            ...
                            return (
                                <div key={i} className=" bg-slate-400 rounded-lg flex-none relative">
                                    <p className="absolute text-white bg-slate-900 bg-opacity-75 px-4 w-full py-8 text-center flex justify-center items-center text-lg md:text-[24px] each_video">{each.Title}</p>
                ...
                <div className='flex gap-[13px] overflow-x-scroll'>
                    {
                        video.filter((each) => {
                            ...
                            return (
                                <div key={i} className=" bg-slate-400 rounded-lg flex-none relative">
                                    <p className="absolute text-white bg-slate-900 bg-opacity-70 px-4 w-full py-8 text-center flex justify-center items-center text-lg md:text-[24px] each_video">{each.Title}</p>
                                    <img src={each.Poster} alt={each.Title} className="each_video" />
                                </div>
                            )
                        })
